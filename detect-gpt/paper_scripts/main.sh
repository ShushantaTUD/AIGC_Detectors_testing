python run.py --output_name main --base_model_name gpt2-xl --mask_filling_model_name t5-3b --n_perturbation_list 1,10,100 --n_samples 500 --pct_words_masked 0.3 --span_length 2 --openai_key sk-proj-qcfDf8rPYJuCgl9ApM7uT3BlbkFJkvsGxShgm2qcA0ggkMLc
