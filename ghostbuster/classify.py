...
trigram_prev = np.array(score_ngram(doc, trigram_model, enc.encode, n=3, strip_first=False))
trigram = trigram_prev[:1031]
unigram_prev = np.array(score_ngram(doc, trigram_model.base, enc.encode, n=1, strip_first=False))
unigram = unigram_prev[:1031]
